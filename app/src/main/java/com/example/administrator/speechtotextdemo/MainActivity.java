...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public static String languageString = Locale.getDefault().toString();
    ...
    public void initOnClickListener() {
        mainBinding.defaultCustomToggleButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mainBinding.defaultCustomToggleButton.setChecked(true);
                ...
                languageString = Locale.getDefault().toString();
        ...
        mainBinding.chineseCustomToggleButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mainBinding.defaultCustomToggleButton.setChecked(false);
